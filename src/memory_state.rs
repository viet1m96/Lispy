...
impl MmioState {
    ...
    pub fn input_data_pending(&self) -> bool {
        self.in_status & IN_STATUS_HAS_DATA != 0
    }

    pub fn latch_input_byte(&mut self, byte: u8) {
        self.irq_ack = 0;
...
impl MemoryState {
    ...
    pub fn input_data_pending(&self) -> bool {
        self.mmio.input_data_pending()
    }

    pub fn input_interrupt_pending(&self) -> bool {
        self.input_data_pending()
    }

    pub fn latch_input_byte(&mut self, byte: u8) {
        self.mmio.latch_input_byte(byte);
    }
